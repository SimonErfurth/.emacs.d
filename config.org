...
#+begin_src emacs-lisp
  (defhydra hydra-open (nil nil :exit t)
    "open"
    ("o" (find-file "~/Dropbox/8. semester/DM860/notes/notes.org") "DM860F")
    ("H-o" (find-file "~/Dropbox/8. semester/DM860/ex/ex.org") "DM860E")
    ("C-o" (find-file "~/Dropbox/8. semester/DM860 Allan Borodin, Ran El-Yaniv - Online Computation and Competitive Analysis-Cambridge University Press (1998).pdf") "DM860B")
    ("v" (find-file "~/Dropbox/8. semester/MM853/notes/notes.tex") "MM853F")
    ("H-v" (find-file "~/Dropbox/8. semester/MM853/ex/ex.tex") "MM853E")
    ("C-v" (find-file "~/Dropbox/8. semester/MM853 Advanced-Vector-Spaces.pdf") "MM853B")
    ("m" (find-file "~/Dropbox/8. semester/DM870/notes/notes.org") "DM870F")
    ("H-m" (find-file "~/Dropbox/8. semester/DM870/ex/ex.org") "DM870E")
    ("C-m" (find-file "~/Dropbox/8. semester/DM870/Pang-Ning Tan, Michael Steinbach, Vipin Kumar - Introduction to Data Mining-Pearson (2013).pdP") "DM870B")
    ("d" (find-file "~/Dropbox/8. semester/DM803/notes/notes.org") "DM803F")
    ("H-d" (find-file "~/Dropbox/8. semester/DM803/ex/ex.org") "DM803E")
    ("C-d" (find-file "~/Dropbox/8. semester/DM803 - Introduction_To_Algorithms.pdf") "DM803B")
    ("l" (find-file "~/Dropbox/8. semester/DM846/notes/notes.org") "DM846F")
    ("H-l" (find-file "~/Dropbox/8. semester/DM846/ex/ex.org") "DM846E")
    ("C-l" (find-file "~/Dropbox/7. semester/DM846/LectureNotes.pdf") "DM846B")
    ("w" (find-file "~/serfurth.dk/index.org") "serfurth.dk")
    ("tt" (dired "~/Dropbox/TA/BMB539 20f") "TA")
