...
#+begin_src emacs-lisp
  (defhydra hydra-open (nil nil :exit t)
    ...
    ("C-k" (find-file "~/Dropbox/9. semester/MM854 Konrad Schmüdgen (auth.) - Unbounded Self-adjoint Operators on Hilbert Space-Springer Netherlands (2012).pdf") "MM854B")
    ("g" (find-file "~/Dropbox/9. semester/MM856/notes/notes.tex") "MM856F")
    ("H-g" (find-file "~/Dropbox/9. semester/MM856/ex/ex.org") "MM856E")
...
TODO: Make - a snippet for \overline (and remove it for \item)
