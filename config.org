...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    ;; Send mail -- this is now set on a context basis?
    ...
    ;; Customization
    ;; In protonmail, a deletion is just moving a mil to the Trash folder. This is supported by the following (press dd)
    ...
    ;; Set context. Currently just one for Proton
    ;; mu4e-context
          ...
          (list
           (make-mu4e-context
            ...
            :vars '((user-mail-address . "erfurth@imada.sdu.dk")
                    ...
                    ;; (smtpmail-auth-credentials . "~/.authinfoSDU.gpg")
                    ;; (smtpmail-default-smtp-server . "127.0.0.1")
                    ;; (smtpmail-smtp-server . "127.0.0.1")
