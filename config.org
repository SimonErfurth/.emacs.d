...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    ;; Old send mail -- this is now set on a context basis using msmtp (this only works with proton/single mail)
    ...
    ;; (define-key mu4e-headers-mode-map (kbd "d") 'mu4e-headers-mark-for-move)
...
** org-msg
Looks fantastic! But I need to get this working when replying to emails too.
