...
enough to share (some of it I even give credit for) and a (small) amount of code
that I have written myself. The =init.el=, as well as most of the original base
of this file is stolen from *Uncle Dave's Emacs*.
** Dependencies
...
#+begin_src emacs-lisp
  ...
  Git gutter:
    ...
    ^ ^                   _P_opup hunk
    _b_: first hunk
    _f_: last hunk        set start _R_evision
  "
    ("n" git-gutter:next-hunk)
    ("p" git-gutter:previous-hunk)
    ("b" (progn (goto-char (point-min))
