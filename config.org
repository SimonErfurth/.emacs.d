...
#+begin_src emacs-lisp
  (defhydra hydra-open (nil nil :exit t)
    ...
    ("C-c" (find-file "~/Dropbox/8. semester/DM860 Allan Borodin, Ran El-Yaniv - Online Computation and Competitive Analysis-Cambridge University Press (1998).pdf") "DM860B")
    ...
    ("C-m" (find-file "~/Dropbox/8. semester/DM870 Functional Analysis.pdf") "DM870B")
    ("d" (find-file "~/Dropbox/7. semester/MM831/notes/notes.tex") "MM831F")
    ("H-d" (find-file "~/Dropbox/7. semester/MM831/ex/ex.tex") "MM831E")
    ("C-d" (find-file "~/Dropbox/7. semester/MM831/LectureNotes.pdf") "MM831B")
